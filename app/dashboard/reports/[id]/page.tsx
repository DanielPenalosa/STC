...
export default async function ReportDetailPage({
  ...
  return (
    <div className="mx-auto max-w-7xl">
      ...
      <div className="mt-2 flex flex-wrap items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <div className="mt-1.5 flex flex-wrap items-center gap-2 text-sm">
            ...
            <span className="hidden text-slate-500 sm:inline">Submitted {fmtShort(report.created_at)}</span>
            {report.title && (
      ...
      {/* status strip — full width under the header so the process is the
          first thing both admins and citizens see (was buried in the right
          rail, where the 7-step labels crushed together on phones) */}
      ...
      <div className="mt-4 grid items-start gap-4 lg:grid-cols-[1fr_400px]">
        ...
        <div className="space-y-4">
          ...
          <section className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            ...
            <div className="grid grid-cols-1 gap-y-4 px-4 py-4 sm:grid-cols-2 sm:gap-x-6 sm:gap-y-5 sm:px-6">
